        ...
        <div class="row mt-n2 wow fadeInUp justify-content-center" data-wow-delay="0.1s">
            <div class="col-md-6 col-sm-12 mb-5">
                <div class="input-group mb-5 grid grid-cols-4 gap-4">
                    ...
                    <x-simple-select class=" dark:bg-gray-800 dark:border-gray-800 px-4 dark:placeholder-gray-500 dark:text-gray-400 py-2.5 text-base text-gray-900 rounded-lg font-normal border border-gray-200" wire:model.debounce.300ms="selectedTransmission" name="statusPekerjaan" id="statusPekerjaan" :options="$jenisKendaraan" value-field='id' text-field='nama' placeholder="Pilih jenis transmisi" />
                    <x-simple-select class=" dark:bg-gray-800 dark:border-gray-800 px-4 dark:placeholder-gray-500 dark:text-gray-400 py-2.5 text-base text-gray-900 rounded-lg font-normal border border-gray-200" wire:model.debounce.300ms="selectedBrand" name="statusPekerjaan" id="statusPekerjaan" :options="$brands" value-field='id' text-field='nama' placeholder="Pilih brand" />
                    <x-simple-select class=" dark:bg-gray-800 dark:border-gray-800 px-4 dark:placeholder-gray-500 dark:text-gray-400 py-2.5 text-base text-gray-900 rounded-lg font-normal border border-gray-200" wire:model.debounce.300ms="selectedJenisKendaraan" name="statusPekerjaan" id="statusPekerjaan" :options="$categories" value-field='id' text-field='nama' placeholder="Pilih jenis kendaraan" />
                </div>
            </div>
        </div>
