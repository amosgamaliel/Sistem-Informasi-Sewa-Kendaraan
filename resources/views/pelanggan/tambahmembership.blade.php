                    ...
                    <div class="mb-3">
                        <div class="flex">
                            <div class="w-1/2 pr-2">
                                <label class="block text-sm font-medium text-gray-600">Harga <i class="fas fa-calendar-alt"></i></label>
                                <input type="number" class="mt-1 p-2 w-full border rounded-md" name="harga" required>
                            </div>
                            </div>
                        </div>
                    </div>
