                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="/updatedata/{{$data->id}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="model_kendaraan"
                                        ...
                                        value="{{ $data->model_kendaraan }}">
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Tipe Kendaraan</label>
                                    <select class="form-select" name="tipe_kendaraan_id"
                            ...
                            <div class="mb-3">
                                ...
                                id="exampleInputEmail1" aria-describedby="emailHelp" value="{{$data->nomor_polisi}}">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Tahun Pembuatan</label>
                                    <input type="text" name="tahun_pembuatan" class="form-control"
                                        id="exampleInputEmail1" aria-describedby="emailHelp" value="{{$data->tahun_pembuatan}}">
                                </div>
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Harga Sewa/Hari</label>
                                    <input type="text" name="harga_sewa" class="form-control"
                                        id="exampleInputEmail1" aria-describedby="emailHelp" value="{{$data->harga_sewa}}">
                                </div>
