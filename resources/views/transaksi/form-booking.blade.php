    ...
    <div class="flex items-center bg-gray-100 font-poppins dark:bg-gray-800 ">
        <div class="justify-center flex-1 max-w-6xl py-4 mx-auto text-center lg:py-10 ">
            <div class="" x-data="{ open: false }">
                <div class="flex gap-4 mb-6" @click="open = true">
                ...
                <div class="absolute top-0 left-0 flex items-center justify-center w-full max-h-1/3" style="background-color: rgba(0,0,0,.5);" x-show="open">
